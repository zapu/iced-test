...
(function() {
  var $, BAD_X, BrowserRunner, CHECK, Case, File, Runner, ServerRunner, WAYPOINT, deep_equal, fs, get_outside_callsite_stackline, iced, main, path, run, sort_fn, __iced_k, __iced_k_noop,
