...
(function() {
  var $, BAD_X, BrowserRunner, CHECK, Case, File, Runner, ServerRunner, WAYPOINT, colors, deep_equal, format_stack_frame_str, fs, get_relevant_stack_frames, iced, main, path, run, sort_fn, util, __iced_k, __iced_k_noop,
            ...
            if (!(_i < _len)) {
              ...
              (function(__iced_k) {
                __iced_deferrals = new iced.Deferrals(__iced_k, {
                  ...
                  filename: "/home/zapu/Projects/iced_test_improvements/iced-test/index.iced",
