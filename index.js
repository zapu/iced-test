...
(function() {
  var $, BAD_X, BrowserRunner, CHECK, Case, File, Runner, ServerRunner, WAYPOINT, colors, deep_equal, fs, iced, main, path, run, run_test_case_with_catch, sort_fn, urlmod, vm, __iced_k, __iced_k_noop,
  ...
  run_test_case_with_catch = function(code, case_obj, cb) {
    var e;
    try {
  ...
  Runner = (function() {
    ...
    Runner.prototype.new_file_obj = function(filename) {
      return new File(filename, this);
    };

    Runner.prototype.run_code = function(filename, code, cb) {
      var C, destroy, err, fo, hit_error, k, ok, v, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      fo = this.new_file_obj(filename);
      (function(_this) {
        return (function(__iced_k) {
          if (code.init != null) {
            (function(__iced_k) {
        ...
        return function() {
          ...
          (function(__iced_k) {
            if (err) {
              return __iced_k(_this.err("Failed to initialize file " + filename + ": " + err));
            } else {
              _this._n_good_files++;
              (function(__iced_k) {
                ...
                _while = function(__iced_k) {
                  ...
                  if (!(_i < _keys.length)) {
                    ...
                    (function(__iced_k) {
                      ...
                      run_test_case_with_catch(v, C, __iced_deferrals.defer({
                        assign_fn: (function() {
                          return function() {
                            return err = arguments[0];
                          };
                      ...
                      if (err) {
                        _this.err("In " + filename + "/" + k + ": " + err);
                        hit_error = true;
                      }
                      return _next(C.is_ok() && !hit_error ? (_this._successes++, _this.report_good_outcome("" + CHECK + " " + filename + ": " + k)) : _this.report_bad_outcome("" + BAD_X + " TESTFAIL " + filename + ": " + k));
                    });
                  }
                };
                _while(__iced_k);
    ...
    _intra_vm_func = function(fo, cb) {
      var T, destroy, err, func, k, ok, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      (function(_this) {
        return (function(__iced_k) {
          if (codeObj.init != null) {
            (function(__iced_k) {
              __iced_deferrals = new iced.Deferrals(__iced_k, {
                parent: ___iced_passed_deferral,
                filename: "/home/zapu/Projects/iced-test/index.iced",
              ...
              codeObj.init(fo.new_case(), __iced_deferrals.defer({
                assign_fn: (function() {
                  return function() {
                    return err = arguments[0];
                  };
    ...
    Runner.prototype.run_code_in_vm = function(filename, cb) {
      var codeObj, fo, res, sandbox, ___iced_passed_deferral, __iced_deferrals, __iced_k, _ref;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      if (vm == null) {
        vm = require('vm');
      ...
      fo = this.new_file_obj(filename);
      sandbox = {
        require: ((_ref = module.parent) != null ? _ref : module).require,
        fo: fo
      };
      vm.createContext(sandbox);
      vm.runInContext("codeObj = require('" + filename + "')", sandbox);
      console.log(sandbox);
      codeObj = sandbox.codeObj;
      (function(_this) {
        return (function(__iced_k) {
          if (codeObj.init) {
            res = null;
...
_break()
                    ...
                    (function(__iced_k) {
                      __iced_deferrals = new iced.Deferrals(__iced_k, {
                        parent: ___iced_passed_deferral,
                        filename: "/home/zapu/Projects/iced-test/index.iced",
                        funcname: "Runner.run_code_in_vm"
                      });
            ...
            return __iced_k(vm.runInContext("fo.default_init()", sandbox));
          }
        });
      })(this)((function(_this) {
        return function() {
          console.log("::::: rip");
          return cb(new Error("wip"));
        };
      })(this));
    };

    Runner.prototype.prepare_code_str = function(full_path) {
      var code_str, extname, loadFunc, _ref;
      ...
      code_str = loadFunc((_ref = module.parent) != null ? _ref : module, full_path);
      return code_str;
    };
  ...
  exports.ServerRunner = ServerRunner = (function(_super) {
    ...
    ServerRunner.prototype.run_file = function(f, cb) {
      var e, m, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      (function(_this) {
        return (function(__iced_k) {
          try {
            ...
            _this.run_code_in_vm(m, __iced_deferrals.defer({
              lineno: 289
            }));
            __iced_deferrals._fulfill();
          } catch (_error) {
