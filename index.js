...
(function() {
  var $, BAD_X, BrowserRunner, CHECK, Case, File, Runner, ServerRunner, WAYPOINT, deep_equal, fs, get_outside_callsite_stackline, iced, main, path, run, run_test_case_guarded, sort_fn, __iced_k, __iced_k_noop,
        ...
        return (function(__iced_k) {
          if (code.init != null) {
            (function(__iced_k) {
              ...
              run_test_case_guarded(code.init, fo.new_case(), __iced_deferrals.defer({
                assign_fn: (function() {
                  return function() {
                ...
                _while = function(__iced_k) {
                  ...
                  if (!(_i < _keys.length)) {
                    ...
                    (function(__iced_k) {
                      ...
                      run_test_case_guarded(v, C, __iced_deferrals.defer({
                        assign_fn: (function() {
                          return function() {
                            return err = arguments[0];
                          };
            ...
            (function(__iced_k) {
              if (destroy != null) {
                (function(__iced_k) {
                  ...
                  run_test_case_guarded(destroy, fo.new_case(), __iced_deferrals.defer({
                    assign_fn: (function() {
                      return function() {
                        return err = arguments[0];
                      };
