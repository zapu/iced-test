...
(function() {
  var $, BAD_X, BrowserRunner, CHECK, Case, File, Runner, ServerRunner, WAYPOINT, deep_equal, fs, get_outside_callsite_stackline, iced, main, path, run, run_test_case_with_catch, sort_fn, __iced_k, __iced_k_noop,
  ...
  run_test_case_with_catch = function(code, case_obj, gcb) {
    var cb, cb_called, err, remove_uncaught;
        ...
        return (function(__iced_k) {
          if (code.init != null) {
            (function(__iced_k) {
              ...
              run_test_case_with_catch(code.init, fo.new_case(), __iced_deferrals.defer({
                assign_fn: (function() {
                  return function() {
                ...
                _while = function(__iced_k) {
                  ...
                  if (!(_i < _keys.length)) {
                    ...
                    (function(__iced_k) {
                      ...
                      return _next(C.is_ok() && !hit_error ? (_this._successes++, _this.report_good_outcome("" + CHECK + " " + fn + ": " + k)) : _this.report_bad_outcome("" + BAD_X + " TESTFAIL " + fn + ": " + k));
                    });
                  }
                };
                _while(__iced_k);
            ...
            (function(__iced_k) {
              if (destroy != null) {
                (function(__iced_k) {
                  ...
                  run_test_case_with_catch(destroy, fo.new_case(), __iced_deferrals.defer({
                    assign_fn: (function() {
                      return function() {
                        return err = arguments[0];
                      };
